...
Begin VB.Form frmtest_paper 
   ...
   ClientTop       =   0
   ClientWidth     =   8160
   Icon            =   "frmtest_paper.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmtest_paper.frx":000C
   ScaleHeight     =   7620
   ScaleWidth      =   8160
   ...
   Begin VB.CommandButton cmdjump 
      ...
      Height          =   375
      Left            =   3000
      MouseIcon       =   "frmtest_paper.frx":4519
      MousePointer    =   99  'Custom
      Picture         =   "frmtest_paper.frx":4823
      Style           =   1  'Graphical
      TabIndex        =   35
      Top             =   6360
      Visible         =   0   'False
   ...
   Begin VB.CommandButton cmd_abort 
      ...
      Height          =   375
      Left            =   360
      MouseIcon       =   "frmtest_paper.frx":4E20
      MousePointer    =   99  'Custom
      Picture         =   "frmtest_paper.frx":512A
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmd_next 
      ...
      Height          =   375
      Left            =   5520
      MouseIcon       =   "frmtest_paper.frx":5727
      MousePointer    =   99  'Custom
      Picture         =   "frmtest_paper.frx":5A31
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   6360
      Width           =   1935
   ...
   Begin VB.Image Image1 
      Height          =   1095
      Left            =   2640
      Picture         =   "frmtest_paper.frx":6038
      Top             =   120
      Width           =   2700
   End
