...
Begin VB.Form frmLogin 
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   375
      Left            =   3360
      MouseIcon       =   "frmLogin.frx":40A2
      MousePointer    =   99  'Custom
      Picture         =   "frmLogin.frx":43AC
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4560
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdLogin 
      ...
      Left            =   2040
      MaskColor       =   &H00FFFFC0&
      MouseIcon       =   "frmLogin.frx":49A9
      MousePointer    =   99  'Custom
      Picture         =   "frmLogin.frx":4CB3
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4560
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton cmdstart 
      ...
      Height          =   375
      Left            =   2040
      MouseIcon       =   "frmLogin.frx":52B0
      MousePointer    =   99  'Custom
      Picture         =   "frmLogin.frx":55BA
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   4560
      Visible         =   0   'False
...
Private Sub cmdLogin_Click()
    ...
    If txtPassword.Text = "" Or txtUserID.Text = "" Then
        MsgBox "One of your login fields is blank, please try again.", , "Attention"
        Exit Sub
    End If
